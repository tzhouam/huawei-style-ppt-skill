---
name: ppt-density-playbook
description: PPT 密度填充参考手册 — 8 种混合布局填充手段、间距规则、页面构成模板、SmartArt/截图 CSS 模板、spike 教训。02-slide-authoring.md 的深度参考。
---

# 密度填充 Playbook

> 画 HTML 前必查。来源：2026-04-03 spike 迭代 + 铲屎官反馈 + D5 垂直切片（2026-04-05）。
...
```html
<div class="kpi"><span class="text-[30px] font-black">4</span> <span class="text-[11px]">AI 角色协作</span></div>
```
...
9. **单一证据源约束**：页面上所有数字必须可追溯到声明的证据源（D1 审查 P1 教训）
10. **观看模式自洽**：7-8px 字号 = document 模式，不要声明 presentation（P1 教训）
